                ...
                $('table tr').click(function () {
                    if (DELETE_OVERLAP) {
                        ...
                        if (itemIndex > 0) {
                            ...
                            var url = "purchase-update.php?q=" + itemId;
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (resobj.success) {
                if (resobj.status == "CREDIT") {
                    alert("This Bill Can't Be Delete.First Delete Payment And Try Again")
                ...
                if (resobj.status == "LESS THAN 0") {
                    alert("This item is already sold.if you you want to delete this bill,1-YOU NEED TO ADD PERFECT PURCHASE BILL AND TRY TO DELTE.2-DELETE ASSOCIATED SALES BILL FIRST AND TRY AGAIN");
                    /* for (var key in resobj.stock) {
                         alert(key);
                     }*/
