                ...
                <div class="row">
                    ...
                    <div class="col-md-4 offset-md-4">
                        <div class="form-group ">
                            <label class="colun" for="name">Vendor Name </label>
                            <div class="inputs">
                ...
                <div class="container-fluid">
                    <div class="wrapper">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="colun" for="isbal">Stock Bal</label>
                                    <div class="inputs">
                                        <input type="number" min="0" class="form-control" id="isbal" autocomplete="off"
                                            placeholder="Stock Bal" disabled>
