...
<body>
    <main class="purchase-page position-relative">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="inputs  labelled">
                            ...
                            <input class="search-inputs" type="text" id="gst-no" placeholder="GST No"
                                autocomplete='off'>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="inputs  labelled">
                            <label for="cust-id">Vendor-ID</label>
                            <input class="search-inputs use-list" type="number" id="cust-id" placeholder="Vendor-ID"
                                autocomplete='off'>
                            <ul class="list cust-id">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="inputs  labelled">
                            <label for="cust-name">Vendor Name</label>
                            <input class="search-inputs use-list" type="text" id="cust-name" placeholder="Vendor Name"
                                autocomplete='off'>
                    ...
                    <div class="inputs  labelled">
                      <label for="vbid">Vendor Bill Id</label>
                      <input class="search-inputs" type="text" id="vbid" placeholder="Vendor Bill Id" autocomplete='off'>
                    </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="inputs  labelled">
                            ...
                            <input class="search-inputs use-list" type="text" id="cust-address" placeholder="Address"
                                autocomplete='off'>
                            <ul class="list cust-address">
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <section class="billing">
            <div class="container-fluid">
                <div class="wrapper">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="pur-taxi">IGST %</label>
                            <input type="number" id="pur-taxi" disabled>
                        </div>
                        <div class="col-md-3">
                            <label for="pur-taxc">CGST %</label>
                            <input type="number" id="pur-taxc" disabled>
                        </div>
                        <div class="col-md-3">
                            <label for="pur-taxs">SGST %</label>
                            <input type="number" id="pur-taxs" disabled>
                        </div>
                        ...
                        <div class="col-md-3 justify-content-end">
                            ...
                            <input type="text" id="pur-pay" disabled>
                        </div>
                    </div>
                ...
                <div class="btn-grp">
                    ...
                    <label for="pur-dis-per">Percentage Discount</label>
                    <input type="number" id="pur-dis-per">
                    <label for="pur-dis">Discount</label>
                    <input type="number" id="pur-dis">
                    <button class="btn btn-primary ml-auto" onclick="discAdjust()">Adjust</button>

                    <input type='button' class="btn btn-primary ml-auto" onClick="closePage()" value="Close">
                </div>
            </div>
        </section>
    ...
    <script src="upjs/drop.js"></script>
