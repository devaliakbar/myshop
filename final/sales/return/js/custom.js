        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (resobj.success) {
                ...
                for (var i = 0; i < cursor.length; i++) {
                    ...
                    appendRaw += "<td class='grid-dis'><input type='text' autocomplete='off' disabled value='" + cursor[i].dis + "'></td>";
                    appendRaw += "<td class='grid-dis-per'><input type='text' autocomplete='off' disabled value='" + cursor[i].disper + "'></td>";
